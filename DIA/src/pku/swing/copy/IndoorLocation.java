...
public class IndoorLocation extends javax.swing.JFrame
{
	...
	public IndoorLocation()
	{
		...
		this.setTitle("JLabel Test");
		//frame.setLayout(new FlowLayout());
		this.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		ImageIcon imageIcon = new ImageIcon("map//map.jpg");
		p.setLayout(null);
		p2.setLayout(null);
		...
		buttonClear.setLocation(601, 225);
	...
	protected void buttonFindShortestPathActionPerformed(ActionEvent evt)
	{
		...
		lbs.entity.Zone startZone = MonitorHelper.getLocationUtil().getZoneById(MonitorHelper.getRegion(),zoneID1);//起点
		lbs.entity.Zone destZone = MonitorHelper.getLocationUtil().getZoneById(MonitorHelper.getRegion(),zoneID2);//终点
		//调用返回的是一个zone的
				...
				while(itZones.hasNext())
				{
					...
					if(zoneID!=0)
					{
						...
						while(itT.hasNext())
						{
							...
							System.out.println(t.getFriendlyName());
							ContextLabel cl = new ContextLabel(new ImageIcon("map//point.jpg"),t.getFriendlyName(),locationx,locationy);
							alllables.add(cl);
						}
					}
