...
public class BlipZoneEventSource implements ZoneEventSource,Runnable
{
	...
	public BlipZoneEventSource(LocationProvider locationProvider, Zone zone)
	{
		super();
	...
	public void addListener(TerminalEventListener e)
	{
		listeners.add(e);

	}

	public void removeListener(TerminalEventListener e)
	{
		listeners.remove(e);
